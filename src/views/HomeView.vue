<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Xabi Fabian Suwandi</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-9/10 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://files.catbox.moe/bzrldr.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Graphic Designer", "3D Designer", "Photography", "Videography"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
